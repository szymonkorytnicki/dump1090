const MarkerColor = "rgb(127, 127, 127)";
const SelectedColor = "rgb(225, 225, 225)";
const StaleColor = "rgb(190, 190, 190)";

const PlanePath =
  "M 0,0 M 0,0 M 1.9565564,41.694305 C 1.7174505,40.497708 1.6419973,38.448747 " +
...
export function PlaneIcon({ isSelected = false, seen, squawk, track }: PlaneIconProps) {
  const { fillColor, path, strokeWidth } = getIcon({ isSelected, seen, squawk, track });
  return (
    <svg width={24} height={24} viewBox="0 0 26 26" style={{ transform: `rotate(${track}deg)` }}>
      <path
        fill={fillColor}
        stroke="black"
...
function getIcon({ isSelected, seen, squawk, track }: PlaneIconProps) {
